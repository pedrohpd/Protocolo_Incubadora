...
NOMES_DISPOSITIVOS = {
    ID_GERENCIADOR: "GERENCIADOR",
    ID_SENSOR_TEMP: "SENSOR DE TEMPERATURA",
    ID_SENSOR_UMID: "SENSOR DE UMIDADE",
    ID_SENSOR_OXIG: "SENSOR DE OXIGENAÇÃO",
    ID_SENSOR_BAT_CARD: "SENSOR DE BATIMENTOS CARDÍACOS",
    ID_ATUADOR_AQUEC: "ATUADOR DE AQUECIMENTO",
    ID_ATUADOR_UMID: "ATUADOR DE UMIDADE",
    ID_ATUADOR_CIRC_AR: "ATUADOR DE CIRCULAÇÃO DO AR",
    ID_CLIENTE: "CLIENTE"
}
